...
public interface SnapshotStatusNotifications<T extends DataCollectionId> {
    ...
    Field NAME = Field.create(CONFIGURATION_FIELD_PREFIX_STRING + "name")
            .withDisplayName("Logical name for the snapshot notifications")
            .withType(ConfigDef.Type.STRING)
            .withWidth(ConfigDef.Width.MEDIUM)
            .withImportance(ConfigDef.Importance.LOW)
            .withDescription("The name used for the snapshot notifications, perhaps differently by each implementation.")
